...
<meta content="FD8yQS4h8TcyK02ZuKEumWjMQXlEMYoi/WU7eWS3pNQ=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-5fe05bba981d40bbf5e1c773c913d045716f46db.css" media="screen" rel="stylesheet" type="text/css" />
      ...
      <script src="https://a248.e.akamai.net/assets.github.com/assets/github-91406482f354d45c50e6e560e925980659cd060f.js" type="text/javascript"></script>
        ...
        <link rel='permalink' href='/tpope/vim-vividchalk/blob/fd696065c7b27e8fca91907ba51151a887c36803/colors/vividchalk.vim'>
    ...
    <meta property="twitter:title" content="tpope/vim-vividchalk"/>
...
<ul class="pagehead-actions">
    ...
    <li class="js-toggler-container js-social-container starring-container ">
      <a href="/tpope/vim-vividchalk/unstar" class="minibutton js-toggler-target star-button starred upwards" title="Unstar this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="mini-icon mini-icon-remove-star"></span>
        <span class="text">Unstar</span>
      </a>
      <a href="/tpope/vim-vividchalk/star" class="minibutton js-toggler-target star-button unstarred upwards" title="Star this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="mini-icon mini-icon-star"></span>
        <span class="text">Star</span>
      </a>
      <a class="social-count js-social-count" href="/tpope/vim-vividchalk/stargazers">134</a>
    </li>

        <li>
          <a href="/tpope/vim-vividchalk/fork" class="minibutton js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="nofollow" data-method="post">
            <span class="mini-icon mini-icon-branch-create"></span>
            <span class="text">Fork</span>
          </a>
          <a href="/tpope/vim-vividchalk/network" class="social-count">33</a>
        </li>
              ...
              <h1 itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="entry-title public">
                ...
                <strong><a href="/tpope/vim-vividchalk" class="js-current-repository">vim-vividchalk</a></strong>
              </h1>
            </div>

            
  <ul class="tabs">
    <li><a href="/tpope/vim-vividchalk" class="selected" highlight="[:repo_source, :repo_downloads, :repo_commits, :repo_tags, :repo_branches]">Code</a></li>
    <li><a href="/tpope/vim-vividchalk/network" highlight="[:repo_network]">Network</a></li>
    <li><a href="/tpope/vim-vividchalk/pulls" highlight="[:repo_pulls]">Pull Requests <span class='counter'>1</span></a></li>

      <li><a href="/tpope/vim-vividchalk/issues" highlight="[:repo_issues]">Issues <span class='counter'>2</span></a></li>



    <li><a href="/tpope/vim-vividchalk/graphs" highlight="[:repo_graphs, :repo_contributors]">Graphs</a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/tpope/vim-vividchalk/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter ">1</span></a></li>
    </ul>
      ...
      <div class="select-menu-modal-holder js-menu-content js-navigation-container js-select-menu-pane">
        ...
        <div class="select-menu-modal js-select-menu-pane">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target selected">
                <span class="select-menu-item-icon mini-icon mini-icon-confirm"></span>
                <a href="/tpope/vim-vividchalk/blob/master/colors/vividchalk.vim" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
              </div> <!-- /.select-menu-item -->
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="tags" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target ">
                <span class="select-menu-item-icon mini-icon mini-icon-confirm"></span>
                <a href="/tpope/vim-vividchalk/blob/v2.0/colors/vividchalk.vim" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v2.0" rel="nofollow" title="v2.0">v2.0</a>
              </div> <!-- /.select-menu-item -->
  ...
  <ul class="tabnav-tabs">
    <li><a href="/tpope/vim-vividchalk" class="selected tabnav-tab" highlight="repo_source">Files</a></li>
    <li><a href="/tpope/vim-vividchalk/commits/master" class="tabnav-tab" highlight="repo_commits">Commits</a></li>
    <li><a href="/tpope/vim-vividchalk/branches" class="tabnav-tab" highlight="repo_branches" rel="nofollow">Branches <span class="counter ">1</span></a></li>
  </ul>
...
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:7d3c41cadb5cc7999758fb113471b402 -->
    ...
    <div class="frame-meta">
      ...
      <p title="This is a placeholder element" class="js-history-link-replace hidden"></p>
        ...
        <div class="breadcrumb">
          <span class='bold'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/tpope/vim-vividchalk" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">vim-vividchalk</span></a></span></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/tpope/vim-vividchalk/tree/master/colors" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">colors</span></a></span> / <strong class="final-path">vividchalk.vim</strong> <span class="js-zeroclipboard zeroclipboard-button" data-clipboard-text="colors/vividchalk.vim" data-copied-hint="copied!" title="copy to clipboard"><span class="mini-icon mini-icon-clipboard"></span></span>
        </div>

      <a href="/tpope/vim-vividchalk/find/master" class="js-slide-to" data-hotkey="t" style="display:none">Show File Finder</a>


        
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/bcb807bfc93504d75af6547895b170db?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
    ...
    <div class="commit-title">
        <a href="/tpope/vim-vividchalk/commit/fd696065c7b27e8fca91907ba51151a887c36803" class="message">Change ColorColumn, CursorLine, and CursorColumn to use s:hibg</a>
    </div>

    <div class="participation">
      <p class="quickstat"><a href="#blob_contributors_box" rel="facebox"><strong>2</strong> contributors</a></p>
          <a class="avatar tooltipped downwards" title="tpope" href="/tpope/vim-vividchalk/commits/master/colors/vividchalk.vim?author=tpope"><img height="20" src="https://secure.gravatar.com/avatar/67259dd09c53aef920fe2aca18c7a8e0?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /></a>
    <a class="avatar tooltipped downwards" title="jdelkins" href="/tpope/vim-vividchalk/commits/master/colors/vividchalk.vim?author=jdelkins"><img height="20" src="https://secure.gravatar.com/avatar/bcb807bfc93504d75af6547895b170db?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /></a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
        ...
        <li>
          <img height="24" src="https://secure.gravatar.com/avatar/bcb807bfc93504d75af6547895b170db?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/tpope/vim-vividchalk/blob/fd696065c7b27e8fca91907ba51151a887c36803/colors/vividchalk.vim" data-title="vim-vividchalk/colors/vividchalk.vim at master · tpope/vim-vividchalk · GitHub" data-type="blob">
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.07680s from fe3.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.07740' data-host='fe3'></span>
