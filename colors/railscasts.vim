...
<meta content="FD8yQS4h8TcyK02ZuKEumWjMQXlEMYoi/WU7eWS3pNQ=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-5fe05bba981d40bbf5e1c773c913d045716f46db.css" media="screen" rel="stylesheet" type="text/css" />
      ...
      <script src="https://a248.e.akamai.net/assets.github.com/assets/github-91406482f354d45c50e6e560e925980659cd060f.js" type="text/javascript"></script>
        ...
        <link rel='permalink' href='/ryanb/dotfiles/blob/ca4d95179b62ceb1a760a2922953edd01d75c382/vim/colors/railscasts.vim'>
    <meta property="og:title" content="dotfiles"/>
    <meta property="og:type" content="githubog:gitrepository"/>
    <meta property="og:url" content="https://github.com/ryanb/dotfiles"/>
    <meta property="og:image" content="https://secure.gravatar.com/avatar/8dbf316d36ff66aad4869a4fc3cfbd37?s=420&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png"/>
    <meta property="og:site_name" content="GitHub"/>
    <meta property="og:description" content="dotfiles - config files for zsh, bash, completions, gem, git, irb, rails"/>
    <meta property="twitter:card" content="summary"/>
    <meta property="twitter:site" content="@GitHub">
    <meta property="twitter:title" content="ryanb/dotfiles"/>
...
<ul class="pagehead-actions">
    ...
    <li class="js-toggler-container js-social-container starring-container ">
      <a href="/ryanb/dotfiles/unstar" class="minibutton js-toggler-target star-button starred upwards" title="Unstar this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="mini-icon mini-icon-remove-star"></span>
        <span class="text">Unstar</span>
      </a>
      <a href="/ryanb/dotfiles/star" class="minibutton js-toggler-target star-button unstarred upwards" title="Star this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="mini-icon mini-icon-star"></span>
        <span class="text">Star</span>
      </a>
      <a class="social-count js-social-count" href="/ryanb/dotfiles/stargazers">1,441</a>
    </li>

        <li>
          <a href="/ryanb/dotfiles/fork" class="minibutton js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="nofollow" data-method="post">
            <span class="mini-icon mini-icon-branch-create"></span>
            <span class="text">Fork</span>
          </a>
          <a href="/ryanb/dotfiles/network" class="social-count">621</a>
        </li>
              ...
              <h1 itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="entry-title public">
                ...
                <strong><a href="/ryanb/dotfiles" class="js-current-repository">dotfiles</a></strong>
              </h1>
            </div>

            
  <ul class="tabs">
    <li><a href="/ryanb/dotfiles" class="selected" highlight="[:repo_source, :repo_downloads, :repo_commits, :repo_tags, :repo_branches]">Code</a></li>
    <li><a href="/ryanb/dotfiles/network" highlight="[:repo_network]">Network</a></li>
    <li><a href="/ryanb/dotfiles/pulls" highlight="[:repo_pulls]">Pull Requests <span class='counter'>5</span></a></li>

      <li><a href="/ryanb/dotfiles/issues" highlight="[:repo_issues]">Issues <span class='counter'>5</span></a></li>

      <li><a href="/ryanb/dotfiles/wiki" highlight="[:repo_wiki]">Wiki</a></li>


    <li><a href="/ryanb/dotfiles/graphs" highlight="[:repo_graphs, :repo_contributors]">Graphs</a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/ryanb/dotfiles/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter blank">0</span></a></li>
    </ul>
      ...
      <div class="select-menu-modal-holder js-menu-content js-navigation-container js-select-menu-pane">
        ...
        <div class="select-menu-modal js-select-menu-pane">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target ">
                <span class="select-menu-item-icon mini-icon mini-icon-confirm"></span>
                <a href="/ryanb/dotfiles/blob/custom-bash-zsh/vim/colors/railscasts.vim" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="custom-bash-zsh" rel="nofollow" title="custom-bash-zsh">custom-bash-zsh</a>
              </div> <!-- /.select-menu-item -->
              <div class="select-menu-item js-navigation-item js-navigation-target selected">
                <span class="select-menu-item-icon mini-icon mini-icon-confirm"></span>
                <a href="/ryanb/dotfiles/blob/master/vim/colors/railscasts.vim" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
              </div> <!-- /.select-menu-item -->
  ...
  <ul class="tabnav-tabs">
    <li><a href="/ryanb/dotfiles" class="selected tabnav-tab" highlight="repo_source">Files</a></li>
    <li><a href="/ryanb/dotfiles/commits/master" class="tabnav-tab" highlight="repo_commits">Commits</a></li>
    <li><a href="/ryanb/dotfiles/branches" class="tabnav-tab" highlight="repo_branches" rel="nofollow">Branches <span class="counter ">2</span></a></li>
  </ul>
...
<!-- blob contrib key: blob_contributors:v21:96bb112e658bc5f81c4475bb0a0f5a0a -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:96bb112e658bc5f81c4475bb0a0f5a0a -->
    ...
    <div class="frame-meta">
      ...
      <p title="This is a placeholder element" class="js-history-link-replace hidden"></p>
        ...
        <div class="breadcrumb">
          <span class='bold'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ryanb/dotfiles" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">dotfiles</span></a></span></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ryanb/dotfiles/tree/master/vim" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">vim</span></a></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ryanb/dotfiles/tree/master/vim/colors" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">colors</span></a></span> / <strong class="final-path">railscasts.vim</strong> <span class="js-zeroclipboard zeroclipboard-button" data-clipboard-text="vim/colors/railscasts.vim" data-copied-hint="copied!" title="copy to clipboard"><span class="mini-icon mini-icon-clipboard"></span></span>
        </div>

      <a href="/ryanb/dotfiles/find/master" class="js-slide-to" data-hotkey="t" style="display:none">Show File Finder</a>


        
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/8dbf316d36ff66aad4869a4fc3cfbd37?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
    <span class="author"><a href="/ryanb" rel="author">ryanb</a></span>
    <time class="js-relative-date" datetime="2010-03-09T16:11:20-08:00" title="2010-03-09 16:11:20">March 09, 2010</time>
    <div class="commit-title">
        <a href="/ryanb/dotfiles/commit/639c809f44906ffb42a9fddc14583e742d95d298" class="message">adding ragtag vim plugin</a>
    </div>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
        <li>
          <img height="24" src="https://secure.gravatar.com/avatar/8dbf316d36ff66aad4869a4fc3cfbd37?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/ryanb/dotfiles/blob/ca4d95179b62ceb1a760a2922953edd01d75c382/vim/colors/railscasts.vim" data-title="dotfiles/vim/colors/railscasts.vim at master · ryanb/dotfiles · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/ryanb/dotfiles/raw/master/vim/colors/railscasts.vim" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/ryanb/dotfiles/blame/master/vim/colors/railscasts.vim" class="button minibutton ">Blame</a>
                  <a href="/ryanb/dotfiles/commits/master/vim/colors/railscasts.vim" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.06250s from fe3.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
      ...
      <textarea name="fullscreen-contents" id="fullscreen-contents" class="js-fullscreen-contents" placeholder="" data-suggester="fullscreen_suggester"></textarea>
          <div class="suggester-container">
              <div class="suggester fullscreen-suggester js-navigation-container" id="fullscreen_suggester"
                 data-url="/ryanb/dotfiles/suggestions/commit">
              </div>
          </div>
    </div>
  </div>
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.06307' data-host='fe3'></span>
